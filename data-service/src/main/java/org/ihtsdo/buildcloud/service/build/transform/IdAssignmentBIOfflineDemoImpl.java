...
public class IdAssignmentBIOfflineDemoImpl implements IdAssignmentBI {
	...
	@Override
	public Long createSCTID(final UUID componentUuid, final Integer namespaceId, final String partitionId, final String releaseId, final String buildId, final String moduleId) throws CreateSCTIDFaultException, RemoteException {
		return createNewId(partitionId);
	}

	@Override
	public HashMap<UUID, Long> createSCTIDList(final List<UUID> componentUuidList, final Integer namespaceId, final String partitionId, final String releaseId, final String buildId, final String moduleId) throws RemoteException, CreateSCTIDListFaultException {
	...
	@Override
	public HashMap<IDENTIFIER, String> createConceptIds(final UUID componentUuid, final String parentSnomedId, final Integer namespaceId, final String partitionId, final String releaseId, final String buildId, final String moduleId) throws RemoteException, CreateConceptIdsFaultException {
		throw NOT_IMPLEMENTED_EXCEPTION;
	}

	@Override
	public HashMap<UUID, HashMap<IDENTIFIER, String>> createConceptIDList(final HashMap<UUID, String> componentUUIDandParentSnomedId, final Integer namespaceId, final String partitionId, final String releaseId, final String buildId, final String moduleId) throws RemoteException, CreateConceptIDListFaultException {
		throw NOT_IMPLEMENTED_EXCEPTION;
	}
