...
public interface ReleaseService {
    ...
    void triggerBuildAsync(String releaseCenter, String productKey, Build build, GatherInputRequestPojo gatherInputRequestPojo, SecurityContext securityContext, String rootURL) throws BusinessServiceException;
