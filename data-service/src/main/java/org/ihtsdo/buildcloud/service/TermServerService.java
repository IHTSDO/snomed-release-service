...
public interface TermServerService {
    ...
    File export(String termServer, String branchPath, String effectiveDate, Set<String> excludedModuleId, SnowOwlRestClient.ExportCategory exportCategory) throws BusinessServiceException;
