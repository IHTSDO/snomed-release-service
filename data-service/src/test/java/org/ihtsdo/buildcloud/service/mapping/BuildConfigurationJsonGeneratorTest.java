...
public class BuildConfigurationJsonGeneratorTest {
	...
	public void setup() throws IOException {
		...
		build = new Build(new GregorianCalendar(2013, 2, 5, 16, 30, 0).getTime(), product);
	...
	public void testGetConfig() throws IOException, JSONException {
		String actual = buildConfigurationJsonGenerator.getJsonConfig(build);
