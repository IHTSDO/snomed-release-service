...
public class PermissionServiceTest {
    ...
    public void testRoles() throws RestClientException {
        ...
        Mockito.when(permissionServiceCacheMock.getGlobalRoles(SecurityContextHolder.getContext().getAuthentication().getCredentials().toString())).thenReturn(globalRoles);
        ...
        Mockito.when(permissionServiceCacheMock.getCodeSystemRoles(SecurityContextHolder.getContext().getAuthentication().getCredentials().toString())).thenReturn(userRoleMap);

        Map roleMap = permissionService.getRolesForLoggedInUser(SecurityContextHolder.getContext().getAuthentication());
