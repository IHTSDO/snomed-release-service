...
public class Build {
	...
	public static enum Status {
		QUEUED, BEFORE_TRIGGER, FAILED_INPUT_PREPARE_REPORT_VALIDATION, FAILED_PRE_CONDITIONS, BUILDING, BUILT, UNKNOWN, CANCEL_REQUESTED, CANCELLED, FAILED, RVF_RUNNING, RELEASE_COMPLETE, RELEASE_COMPLETE_WITH_WARNINGS, FAILED_POST_CONDITIONS
	}
