package org.ihtsdo.buildcloud.integration.workbenchworkarround.reconcilemapmemberids;
...
public class ReconcileMapRefsetMemberIdsTestIntegration extends AbstractControllerTest {
	...
	public void setup() throws Exception {
		super.setup();
		integrationTestHelper = new IntegrationTestHelper(mockMvc, "ReconcileMapMemberIdsTest");
	}
